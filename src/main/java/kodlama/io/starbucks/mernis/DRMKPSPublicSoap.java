...
public class DRMKPSPublicSoap
{
    ...
    public DRMKPSPublicSoap(){}

    public DRMKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public DRMKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        DRMExtendedSoapSerializationEnvelope envelope= new DRMExtendedSoapSerializationEnvelope(DRMExtendedSoapSerializationEnvelope.VER11);
