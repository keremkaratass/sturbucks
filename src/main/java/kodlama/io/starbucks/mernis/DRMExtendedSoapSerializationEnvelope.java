...
class DRMSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class DRMExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(DRMDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new DRMStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static DRMDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static DRMDateTimeConverter dateTimeConverter = new DRMStandardDateTimeConverter();

    public DRMExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public DRMExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new DRMMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=DRMHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,DRMExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=DRMHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
